...
using SteamAchievementCaretaker.App.Achievements;
using SteamAchievementCaretaker.App.Common;
using SteamAchievementCaretaker.SteamApi;
using static SteamAchievementCaretaker.App.InvariantShorthand;
using APITypes = SteamAchievementCaretaker.SteamApi.Types;
// A using directive imports a namespace's types but not its nested
// namespaces, so the Stats.* references need an alias of their own.
using Stats = SteamAchievementCaretaker.App.Achievements.Stats;
...
namespace SteamAchievementCaretaker.App.ViewModels
{
    internal sealed partial class ManagerViewModel : ProgressViewModel
    {
        ...
        private readonly SteamApi.Callbacks.UserStatsReceived _UserStatsReceivedCallback;
        ...
        public ManagerViewModel(long gameId, SteamApi.Client client)
        {
            this._GameId = gameId;
        ...
        private void RefreshStats()
        {
            ...
            if (callHandle == SteamApi.CallHandle.Invalid)
            {
        ...
        private bool LoadUserGameStatsSchema()
        {
            ...
            try
            {
                ...
                path = SteamApi.Steam.GetInstallPath();
        ...
        private void OnAchievementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (info.IsProtected == true)
            {
                ...
                this.MessageRaised?.Invoke(
                    "Sorry, but this is a protected achievement and cannot be managed with Steam Achievement Caretaker.",
                    false);
                return;
            }
